...
function awl_modal_popup_box_shortcode($post_id) {
	...
	wp_enqueue_script('mbp-modernizr-custom-js', MPB_PLUGIN_URL .'js/modal/modernizr.custom.js');	// before body load
	wp_enqueue_script('mbp-classie-js', MPB_PLUGIN_URL .'js/modal/classie.js');
	wp_enqueue_script('mbp-cssParser-js', MPB_PLUGIN_URL .'js/modal/cssParser.js');
